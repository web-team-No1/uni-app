	...
	<view>
		...
		<view class="typeQueryNav">
			<view class="typeQueryBack">
				...
				<text class="typeQueryTitle">待报修详情</text>
			</view>
			<view class="filtration">
				...
				<view :class="['trdeSelsct',istrdeSelsct?'openSelsct':'']">
					...
					<view @click="isvisable" class="clickSelect">现场报修</view>
					<view @click="uploadClick" class="clickSelect">返厂报修</view>
					<view @click="dontrepair" class="clickSelect">无法维修</view>
...
<script>
	export default {
		...
		methods: {
			...
			isvisable() {
				uni.navigateTo({
					url: "../readyService/readySerain/scenerepair"
				})
