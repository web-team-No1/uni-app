	...
	<view>
		...
		<view class="typeQueryNav">
			<view class="typeQueryBack">
				...
				<text class="typeQueryTitle">取型验收</text>
			</view>
			<view class="filtration">
				<text class="detailesxg" @click="qualified">合格</text>
				<text class="detailesxg" @click="trdownOpen">驳回</text>
				<text class="typeQueryTitle" @click="trdownOpen">问题反馈</text>
			</view>
		</view>
		<!-- 用户基本信息 -->
