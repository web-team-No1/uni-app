	...
	<view>
		...
		<view class="typeQueryNav">
			<view class="typeQueryBack">
				...
				<text class="typeQueryTitle">试穿待通知</text>
			</view>
		...
		<view class="tbTh">
			...
			<view style="width: 19%;" class="tbThclass">产品昵称</view>
			<view style="width: 10%;" class="tbThclass">交货日期</view>
			<view style="width: 10%;" class="tbThclass">是否加急</view>
			<view style="width: 7%;" class="tbThclass">X光片</view>
			<view style="width: 19%;" class="tbThclass">下单时间</view>
		</view>
		<view v-for="(j,index) in datas" :key="index" :class="['tbTd',index==datas.length - 1? 'notbTd':'']">
			...
			<view style="width: 19%;" name="产品昵称" class="tbTdclass">{{j.productName}}</view>
			...
			<view style="width: 19%;" name="下单时间" class="tbTdclass">{{j.patriarchRe}}</view>
